...
import { Target, Link, ArrowRight, Trash2 } from 'lucide-react';
...
interface DataDestinationNodeProps {
  id: string;
  ports: NodePort[];
...
const DataDestinationNode: React.FC<DataDestinationNodeProps & { onNodeMouseDown?: (e: React.MouseEvent) => void }> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
...
export default DataDestinationNode; 