...
import { MessageSquare, Trash2, Link, ArrowRight } from 'lucide-react';
...
const SlackTeamsNode: React.FC<SlackTeamsNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
