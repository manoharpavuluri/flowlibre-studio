...
import { Cloud, Link, ArrowRight, Trash2 } from 'lucide-react';
...
const S3SourceNode: React.FC<S3SourceNodeProps> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
