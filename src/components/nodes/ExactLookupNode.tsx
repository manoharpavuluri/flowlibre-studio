...
import { Target, Trash2, Link, ArrowRight } from 'lucide-react';
...
interface ExactLookupNodeProps {
  id: string;
  ports: NodePort[];
...
const ExactLookupNode: React.FC<ExactLookupNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
  ...
  >
    {canDelete && (
      <button
        className="absolute top-1 right-1 p-1 rounded-md bg-blue-50 hover:bg-blue-100 text-blue-500 hover:text-blue-700 transition-all duration-200 node-trash"
...
export default ExactLookupNode; 