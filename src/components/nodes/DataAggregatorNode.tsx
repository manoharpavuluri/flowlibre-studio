...
import { Cpu, Link, ArrowRight, Trash2 } from 'lucide-react';
...
interface DataAggregatorNodeProps {
  id: string;
  ports: NodePort[];
...
const DataAggregatorNode: React.FC<DataAggregatorNodeProps> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
...
export default DataAggregatorNode; 