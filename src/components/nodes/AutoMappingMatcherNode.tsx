...
import { Shuffle, Trash2, Link, ArrowRight } from 'lucide-react';
...
interface AutoMappingMatcherNodeProps {
  id: string;
  ports: NodePort[];
...
const AutoMappingMatcherNode: React.FC<AutoMappingMatcherNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
...
export default AutoMappingMatcherNode; 