...
import { Server, Link, ArrowRight, Trash2 } from 'lucide-react';
...
const FTPSourceNode: React.FC<FTPSourceNodeProps> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
