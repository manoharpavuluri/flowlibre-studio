...
import { FileText, Trash2, Link, ArrowRight } from 'lucide-react';
...
const FileWriterNode: React.FC<FileWriterNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
