...
interface EmailAttachmentSourceNodeProps {
  id: string;
  ports: NodePort[];
...
const EmailAttachmentSourceNode: React.FC<EmailAttachmentSourceNodeProps> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
  ...
  const hasContent = false; // No icon or label, only ports
...
export default EmailAttachmentSourceNode; 