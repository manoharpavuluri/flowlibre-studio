...
import { FileText, Link, ArrowRight, Trash2 } from 'lucide-react';
...
const DataParserNode: React.FC<DataParserNodeProps & { onNodeMouseDown?: (e: React.MouseEvent) => void }> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
