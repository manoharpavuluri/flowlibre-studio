...
import { Search, Link, ArrowRight, Trash2 } from 'lucide-react';
...
interface DataMatcherNodeProps {
  id: string;
  ports: NodePort[];
...
const DataMatcherNode: React.FC<DataMatcherNodeProps & { onNodeMouseDown?: (e: React.MouseEvent) => void }> = ({
  id,
  ports,
  portRefs,
  onPortMouseEnter,
...
export default DataMatcherNode; 