...
import { Bell, Trash2, Link, ArrowRight } from 'lucide-react';
...
const AlertNode: React.FC<AlertNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
