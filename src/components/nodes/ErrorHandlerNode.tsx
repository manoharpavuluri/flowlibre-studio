...
import { AlertTriangle, Trash2, Link, ArrowRight } from 'lucide-react';
...
const ErrorHandlerNode: React.FC<ErrorHandlerNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete, onDoubleClick, onNodeMouseDown }) => {
