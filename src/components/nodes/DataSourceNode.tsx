...
import { Database, Link, ArrowRight, Trash2 } from 'lucide-react';
...
const DataSourceNode: React.FC<DataSourceNodeProps> = ({ id, ports, portRefs, onPortMouseEnter, onPortMouseLeave, onPortMouseUp, onPortClick, onPortMouseDown, x, y, canDelete, onDelete }) => {
  ...
  <div
    ...
    onMouseDown={e => {
      // Only start drag if not on port or trash
      ...
      // The onNodeMouseDown prop is removed, so this block is effectively removed.
